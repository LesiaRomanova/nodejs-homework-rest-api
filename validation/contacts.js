...
const validateSchemaUpdateStatusContact = Joi.object({
...
module.exports.validateSchemaUpdateStatusContact = (req, res, nex) => {
  return validate(validateSchemaUpdateStatusContact, req, body, next);
};
